...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'finance/auditdetail', title: '审核详情', name: 'finance:withdraw-record:detail', component: resolve => { require(['@/views/finance/AuditDetail.vue'], resolve); } }
    ]
};
...
let findSlideArr = [
    ...
    { id: 13, path: 'department', title: '实名会员审核', icon: 'ios-person', component: resolve => { require(['@/views/member/Authenticate.vue'], resolve) } },
