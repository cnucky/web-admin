    ...
    <div class="home-main">
        ...
        <Card style="margin-bottom:10px;">
            ...
            <Row span="24" class='clthing'>
                <Col span="9" offset="1" class="od_bottom"><span style='padding-left:10px'>待付款订单</span> <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
                <Col span="9" offset="4" class="od_bottom"><span style='padding-left:10px'>实名会员审核</span>  <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
            </Row>
            <Row span="24" class='clthing'>
                <Col span="9" offset="1" class="od_bottom"><span style='padding-left:10px'>待确认订单</span>  <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
                <Col span="9" offset="4" class="od_bottom"><span style='padding-left:10px'>广告即将到期</span> <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
            </Row>
            <Row span="24" class='clthing clthings' >
                <Col span="9" offset="1" class="od_bottoms"><span style='padding-left:10px'>已完成订单</span> <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
                <Col span="9" offset="4" class="od_bottoms"><span style='padding-left:10px'>商家认证审核</span>  <span class='fir_span'>(<span class='od_right'>10</span>)</span></Col>
            </Row>
        </Card>
        <Card style="margin-bottom:10px;">
            <p slot="title">
